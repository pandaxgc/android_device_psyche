...
# Audio Policy
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/audio_policy/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Sound Triggers
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/sound_trigger/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Audio Platform
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/audio_platform/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Mixer Paths
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/mixer_paths/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Audio Configs
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/audio_configs/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Audio Effects
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/audio_effects/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Tuning
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/tuning/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Volume Tables
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/audio/volume_tables/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Media Codec
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/media/media_codec/,$(TARGET_COPY_OUT_VENDOR)/etc)

# Media Profiles
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/media/media_profiles/,$(TARGET_COPY_OUT_VENDOR)/etc)    
...
# Display Configs *2047 manual slider // *4095 HBM
PRODUCT_COPY_FILES += \
...
PRODUCT_PACKAGES += \
    ...
    Telephony \
    Dialer \
    PsycheSimpleDeviceConfig

PRODUCT_PACKAGES += \
    NotchBarKiller

PRODUCT_ENFORCE_RRO_TARGETS := *
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += $(LOCAL_PATH)/overlay/PsycheCarrierConfig
...
# Inherit MotoSound
# $(call inherit-product-if-exists, vendor/xiaomi/psyche-motodolby/MotoDolby.mk)

# Inherit MiSettings from device.mk
# $(call inherit-product-if-exists, vendor/xiaomi/psyche-misettings/products/apps.mk)
