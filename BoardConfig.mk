...
# Camera - MiuiCamera package name
...
#TARGET_PREBUILT_RECOVERY_RAMDISK_CPIO := $(DEVICE_PATH)/ramdisk/ramdisk-recovery.cpio
#TARGET_PREBUILT_RECOVERY_RAMDISK_IMG := $(DEVICE_PATH)/ramdisk/ramdisk-recovery.img
#TARGET_PREBUILT_RECOVERY_RAMDISK := $(DEVICE_PATH)/ramdisk/ramdisk.img
...
# Inherit from proprietary files for MotoSound
# -include vendor/xiaomi/psyche-motodolby/BoardConfigMotoDolby.mk
